...
const countries = [
  {code: "US", label: "Ayesha in Dallas just booked a trial" },
  {code: "US", label: "1,200+ families taught since 2018" },
  {code: "US", label: "Omar in Chicago started Hifz this week" },
  {code: "US", label: "4.9/5 average tutor rating" },
  {code: "US", label: "Sara in Atlanta booked a trial" },
  {code: "US", label: "1,200+ families taught since 2018" },
  {code: "US", label: "Ayesha in Dallas just booked a trial" },
  {code: "US", label: "1,200+ families taught since 2018" },
  {code: "US", label: "Omar in Chicago started Hifz this week" },
