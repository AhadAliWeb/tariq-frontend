...
const footerLinks = [
  ...
  },
  {
    heading: "Our Courses",
    links: [
      { label: "Nāzira (Quran Reading)", href: "#" },
      { label: "Tajweed Course", href: "#" },
      { label: "Hifz Program", href: "#" },
      { label: "Islamic Studies", href: "#" },
      { label: "Arabic Language", href: "#" },
      { label: "Weekend Classes", href: "#" },
    ],
  },
  {
    heading: "Contact & Support",
    links: [
      { label: "📧 info@quranonline.com", href: "mailto:info@quranonline.com" },
    ...
    <footer className="bg-[var(--color-primary-900)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-[var(--color-secondary-400)] flex items-center justify-center shrink-0">
                <span className="text-[var(--color-primary-900)] font-extrabold text-lg leading-none font-heading">ق</span>
              </div>
              <div>
                <p className="font-heading font-extrabold text-white text-lg leading-tight">Quran</p>
                <p className="text-[var(--color-primary-300)] text-xs">Online Academy</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
        <p className="text-[var(--color-primary-400)] text-xs text-center sm:text-left">
          © {year} Quran Online Academy. All rights reserved.
        </p>
