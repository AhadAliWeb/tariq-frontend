...
export default function CallButton({ phoneNumber = "13322525428", message = "Assalam o Aliakum. I want to enroll for the Demo Class." }) {
  ...
  return (
      <a
        ...
        aria-label="Call us"
        className="fixed bottom-[120px] right-6 z-50 flex items-center justify-center rounded-full bg-blue-600 text-white shadow-lg hover:scale-110 active:scale-95 transition-all duration-300"
        style={{
            width: "80px",
            height: "80px",
        }}
