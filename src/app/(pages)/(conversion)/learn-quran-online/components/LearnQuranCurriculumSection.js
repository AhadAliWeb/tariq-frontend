...
import { ScrollText, Mic2, Brain, Landmark, Languages } from 'lucide-react'
...
const curriculum = [
  {
    ...
    description: 'Build fluent, correct recitation from the ground up.',
  },
  {
    icon: Mic2,
    title: 'Tajweed Rules',
    description: 'Learn proper pronunciation and articulation of Arabic letters.',
  },
  {
    icon: Brain,
    title: 'Hifz (Memorization)',
    description: 'Structured memorization plans with regular revision.',
  },
  {
    icon: Landmark,
    title: 'Islamic Studies',
    description: 'Basic Aqeedah, Fiqh, and daily practice guidance.',
  },
  {
    icon: Languages,
    title: 'Arabic Language',
    description: "Understand what you're reciting, not just the sounds.",
  },
]

export default function LearnQuranCurriculumSection() {
      ...
      <div className="us-page mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="us-page mt-3 text-sm leading-relaxed text-[var(--color-text)] opacity-70 sm:text-base">
            A complete path, whether you're starting from the alphabet or refining fluency.
          </p>
        </div>
