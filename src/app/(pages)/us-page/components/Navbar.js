      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="relative hidden sm:block">
            <span className="absolute inset-0 rounded-md bg-[#FF7100] opacity-60 animate-ping-soft" />
            <button
              className="navbar-cta relative inline-flex cursor-pointer items-center gap-2 px-5 py-2.5 text-sm font-bold bg-[#FF7100] hover:bg-[#FF8500] rounded-md shadow-md hover:shadow-lg transition-all duration-200 active:scale-95"
        ...
        <ul className="px-4 py-3 flex flex-col gap-1">
          ...
          <li className="pt-2 pb-1">
            <div className="relative">
              <span className="absolute inset-0 rounded-xl bg-bg-[#FF7100] opacity-50 animate-ping" />
              <button
                // onClick={() => setMenuOpen(false)}
                onClick={() => setPopupOpen(true)}
                className="navbar-cta relative flex items-center cursor-pointer justify-center gap-2 w-full px-4 py-3 text-sm font-bold text-white bg-[#FF7100] hover:bg-[#FF8500] rounded-xl shadow-md transition-all duration-200"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-secondary-300 animate-pulse shrink-0" />
                Get a free trial
              </button>
