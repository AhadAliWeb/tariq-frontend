...
const faqs = [
  {
    ...
    answer:
      'This varies by student age, pace, and daily commitment — your teacher will set a realistic personalized timeline after the trial assessment.',
  },
  {
    question: 'Is this suitable for adults, or only children?',
    answer:
      'Both. We build separate, realistic memorization plans for children and adults based on their schedules and starting level.',
  },
  {
    question: 'What happens if I fall behind on revision?',
    answer:
      'Your teacher will adjust the schedule and prioritize catching up on revision before adding new memorization.',
  },
  {
    question: 'Do I need to already read Quran fluently to start Hifz?',
    answer:
      'Basic fluent reading is recommended before starting Hifz — if needed, we can begin with a short reading refresher first.',
  },
]

export default function HifzFAQSection() {
